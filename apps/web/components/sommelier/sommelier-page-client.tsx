...
// Page header only. The widget itself is rendered by the server page inside
// its own Suspense boundary (it reads searchParams), so this header stays in
// the statically prerendered HTML.
export function SommelierPageHeader() {
  return (
